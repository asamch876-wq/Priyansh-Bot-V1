...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`———»ADMIN BOT«———\n❯ Name: 𝐒𝐇𝐄𝐇𝐙𝐀𝐃𝐀 🖤\n❯ Facebook: https://www.facebook.com/share/19pXU3PagG/\n❯ Thanks for using ${global.config.BOTNAME} bot`,
    attachment: fs.createReadStream(__dirname + "/https://i.postimg.cc/1XhB5fnQ/20250808-190722.jpg")}, event.threadID, () => 
